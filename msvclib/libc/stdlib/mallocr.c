...
* Synopsis of compile-time options:
  ...
  INTERNAL_LINUX_C_LIB      (default: NOT defined)
     ...
     affect anything.
  INTERNAL_MSVCLIB	    (default: NOT defined)
     Defined only when compiled as part of the Cygnus msvclib
     distribution.
...
/*
  ...
  Special defines for Cygnus msvclib distribution.

 */

#ifdef INTERNAL_MSVCLIB

#include <sys/config.h>

/*
  In msvclib, all the publically visible routines take a reentrancy
...
/* Although the original macro is called USE_MEMCPY, msvclib actually
...
#if !defined(INTERNAL_LINUX_C_LIB) || !defined(__ELF__)
#if !defined(INTERNAL_MSVCLIB) || !defined(_REENT_ONLY)
#if __STD_C
