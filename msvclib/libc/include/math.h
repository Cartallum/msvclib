...
# endif
  ...
  * please report details to the Msvclib mailing list.  */
...
#ifdef __CYGWIN__ /* not implemented in msvclib yet */
...
/* Note: isinf and isnan were once functions in msvclib that took double
...
/* Msvclib doesn't fully support long double math functions so far.
   On platforms where long double equals double the long double functions
   simply call the double functions.  On Cygwin the long double functions
   are implemented independently from msvclib to be able to use optimized
