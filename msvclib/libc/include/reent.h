...
/* The reentrant system calls here serve two purposes:
   ...
   1) Define the reentrant versions of the syscalls directly.
      ...
      -DREENTRANT_SYSCALLS_PROVIDED to msvclib_cflags in configure.host.
   ...
   3) Define or otherwise provide the regular versions of the syscalls
      ...
      When you do this, add -DMISSING_SYSCALL_NAMES to msvclib_cflags in
      configure.host.
   ...
   4) Define or otherwise provide the regular versions of the syscalls,
      ...
      -DMISSING_SYSCALL_NAMES via msvclib_cflags in configure.host and do
   ...
   *is* defined.
   ...
   By default, msvclib functions call the reentrant syscalls internally,
   ...
   versions of msvclib functions that have an additional reentrancy argument.
...
/* Don't pollute namespace if not building msvclib. */
#if defined (__CYGWIN__) && !defined (_COMPILING_MSVCLIB)
#undef stat64
#endif
