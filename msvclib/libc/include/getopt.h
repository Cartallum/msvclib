...
/* While getopt.h is a glibc extension, the following are msvclib extensions.
 * They are optionally included via the __need_getopt_msvclib flag.  */

#ifdef __need_getopt_msvclib
