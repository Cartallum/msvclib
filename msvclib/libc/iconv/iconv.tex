...
code and data will be linked) is to configure Msvclib with the following
options:
@*
@code{--enable-msvclib-iconv-encodings=UTF-8
--enable-msvclib-iconv-from-encodings=KOI8-R
--enable-msvclib-iconv-to-encodings=UCS-2,ISO-8859-5}
@*
which is the same as
@*
@code{--enable-msvclib-iconv-from-encodings=KOI8-R,UTF-8
--enable-msvclib-iconv-to-encodings=UCS-2,ISO-8859-5,UTF-8}
@*
User may also just use the
@*
@code{--enable-msvclib-iconv-encodings=KOI8-R,ISO-8859-5,UTF-8,UCS-2}
@*
configure script option, but it isn't so optimal since there will be
some unneeded data and code.

@*
The @option{--enable-msvclib-iconv-external-ccs} option enables iconv's
capabilities to work with the external CCS files.

@*
The @option{--enable-target-optspace} Msvclib configure script option also affects
...
@option{--enable-msvclib-iconv-external-ccs} configure script option was used,
...
@*
Internally the Msvclib iconv library always converts aliases to names. It
...
The CCS source files aren't distributed with Msvclib because of License
