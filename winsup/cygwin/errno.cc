...
/* Msvclib requires this override for perror and friends to avoid
   ...
   exported, so that only msvclib can use it.  */
extern "C" char *
...
/* strerror: convert from errno values to error strings.  Msvclib's
...
/* Msvclib's <string.h> provides declarations for two strerror_r
