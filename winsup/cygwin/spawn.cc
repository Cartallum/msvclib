...
* Most of these based on (and copied from) msvclib/libc/posix/execXX.c
*/
...
/* The following __posix_spawn_* functions are called from msvclib's posix_spawn
   implementation.  The original code in msvclib has been taken from FreeBSD,
...
/* Replacement for execve/execvpe, called from forked child in msvclib's
