...
AWK = gawk
SED = /usr/bin/sed
BISON = /home/phillip/dev/cbe-utils/msvclib/missing bison
YACC = /home/phillip/dev/cbe-utils/msvclib/missing bison -y
FLEX = /home/phillip/dev/cbe-utils/msvclib/missing flex
LEX = /home/phillip/dev/cbe-utils/msvclib/missing flex
M4 = m4
MAKEINFO = /home/phillip/dev/cbe-utils/msvclib/missing makeinfo
EXPECT = expect
RUNTEST = runtest
...
configure-target:  \
    ...
    maybe-configure-target-msvclib \
...
all-target: maybe-all-target-msvclib
...
info-target: maybe-info-target-msvclib
...
dvi-target: maybe-dvi-target-msvclib
...
pdf-target: maybe-pdf-target-msvclib
...
html-target: maybe-html-target-msvclib
...
TAGS-target: maybe-TAGS-target-msvclib
...
install-info-target: maybe-install-info-target-msvclib
...
install-pdf-target: maybe-install-pdf-target-msvclib
...
install-html-target: maybe-install-html-target-msvclib
...
installcheck-target: maybe-installcheck-target-msvclib
...
mostlyclean-target: maybe-mostlyclean-target-msvclib
...
clean-target: maybe-clean-target-msvclib
...
distclean-target: maybe-distclean-target-msvclib
...
maintainer-clean-target: maybe-maintainer-clean-target-msvclib
...
install-strip-target:  \
    ...
    maybe-install-strip-target-msvclib \
...
.PHONY: configure-target-msvclib maybe-configure-target-msvclib
maybe-configure-target-msvclib:
...
.PHONY: all-target-msvclib maybe-all-target-msvclib
maybe-all-target-msvclib:





.PHONY: check-target-msvclib maybe-check-target-msvclib
maybe-check-target-msvclib:

.PHONY: install-target-msvclib maybe-install-target-msvclib
maybe-install-target-msvclib:

.PHONY: install-strip-target-msvclib maybe-install-strip-target-msvclib
maybe-install-strip-target-msvclib:

# Other targets (info, dvi, pdf, etc.)

.PHONY: maybe-info-target-msvclib info-target-msvclib
maybe-info-target-msvclib:

.PHONY: maybe-dvi-target-msvclib dvi-target-msvclib
maybe-dvi-target-msvclib:

.PHONY: maybe-pdf-target-msvclib pdf-target-msvclib
maybe-pdf-target-msvclib:

.PHONY: maybe-html-target-msvclib html-target-msvclib
maybe-html-target-msvclib:

.PHONY: maybe-TAGS-target-msvclib TAGS-target-msvclib
maybe-TAGS-target-msvclib:

.PHONY: maybe-install-info-target-msvclib install-info-target-msvclib
maybe-install-info-target-msvclib:

.PHONY: maybe-install-pdf-target-msvclib install-pdf-target-msvclib
maybe-install-pdf-target-msvclib:

.PHONY: maybe-install-html-target-msvclib install-html-target-msvclib
maybe-install-html-target-msvclib:

.PHONY: maybe-installcheck-target-msvclib installcheck-target-msvclib
maybe-installcheck-target-msvclib:

.PHONY: maybe-mostlyclean-target-msvclib mostlyclean-target-msvclib
maybe-mostlyclean-target-msvclib:

.PHONY: maybe-clean-target-msvclib clean-target-msvclib
maybe-clean-target-msvclib:

.PHONY: maybe-distclean-target-msvclib distclean-target-msvclib
maybe-distclean-target-msvclib:

.PHONY: maybe-maintainer-clean-target-msvclib maintainer-clean-target-msvclib
maybe-maintainer-clean-target-msvclib:
...
all-target-libgloss: maybe-all-target-msvclib
...
configure-target-msvclib: maybe-all-binutils
configure-target-msvclib: maybe-all-ld
...
configure-target-libstdc++-v3: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libsanitizer: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libmpx: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libvtv: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libcilkrts: maybe-all-target-msvclib maybe-all-target-libgloss
configure-target-libcilkrts: maybe-all-target-libstdc++-v3

configure-target-liboffloadmic: maybe-all-target-msvclib maybe-all-target-libgloss
configure-target-liboffloadmic: maybe-all-target-libstdc++-v3

configure-target-libssp: maybe-all-target-msvclib maybe-all-target-libgloss



configure-target-libbacktrace: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libquadmath: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libgfortran: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libobjc: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libgo: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libtermcap: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-winsup: maybe-all-target-msvclib maybe-all-target-libgloss


configure-target-libffi: maybe-all-target-msvclib maybe-all-target-libgloss
configure-target-libffi: maybe-all-target-libstdc++-v3

configure-target-libjava: maybe-all-target-msvclib maybe-all-target-libgloss
configure-target-libjava: maybe-all-target-libstdc++-v3

configure-target-zlib: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-boehm-gc: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-rda: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libada: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libgomp: maybe-all-target-msvclib maybe-all-target-libgloss

configure-target-libitm: maybe-all-target-msvclib maybe-all-target-libgloss
configure-target-libitm: maybe-all-target-libstdc++-v3

configure-target-libatomic: maybe-all-target-msvclib maybe-all-target-libgloss
