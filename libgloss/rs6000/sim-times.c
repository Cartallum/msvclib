 ...
 * found in COPYING.MSVCLIB.
 * http://sourceware.org/cgi-bin/cvsweb.cgi/src/COPYING.MSVCLIB?rev=1.32&content-type=text/x-cvsweb-markup&cvsroot=src
 */
...
times (struct tms *tp)
{
  ...
  union {
    struct rusage r;
    /* Msvclib's rusage has only 2 fields.  We need to make room for
